...
import '../rules/disallow_context_outside_build_rule.dart';
import '../rules/require_context_in_build_rule.dart';
...
void registerFixes(PluginRegistry registry) {
  registry.registerFixForRule(
    RequireContextInBuildRule.code,
    AddBuildContextArgumentFix.new,
  );
  registry.registerFixForRule(
    DisallowContextOutsideBuildRule.code,
